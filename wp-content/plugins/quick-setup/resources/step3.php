			...
			<?php elseif ( 'contact' === $page['type'] ) : ?>
				<div class="q-setup-item clear-fix page-container" data-index="<?php echo esc_attr( $idx ); ?>" id="q-setup-panel-<?php echo esc_attr( $idx ); ?>">
					...
					<ul class="q-setup-page-info">
						...
						<li>
							<input type="text" name="contact_email[<?php echo esc_attr( $key ); ?>]"class="q-setup-pg-name-input" placeholder="<?php $user = wp_get_current_user(); echo esc_attr( $user->user_email ); ?>" value="<?php echo esc_attr( gd_quicksetup_get_last_value( $key, 'contact_email', $user->user_email ) ); ?>" />
						</li>
						<li>
